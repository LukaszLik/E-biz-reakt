        ...
        <div className="home">
            <div>
                ...
                <div className="button-container">
                        ...
                        <Button component={Link} to="/product-list" variant="contained">LISTA PRODUKTÓW</Button>

                        <Button component={Link} to="/login" variant="contained">ZALOGUJ SIĘ</Button>
                </div>
            <div>
                <img className="sadge" src={"https://emoji.gg/assets/emoji/6757_Sadge.png"} alt="sadge"/>
            </div>
        </div>
    )
}